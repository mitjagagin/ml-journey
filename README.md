...
- **Прогресс:** Matthes Ch.1-8 закрыты полностью (109 учебных скриптов). Детальный план со всеми подглавами — в [`COURSE_PLAN.md`](COURSE_PLAN.md).
- **Стек:** Python 3.10, Miniconda, PyCharm, Git, Docker Desktop
- **Следующий шаг:** Matthes 9.1 (Creating and Using a Class)
