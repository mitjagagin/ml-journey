...
- **Прогресс:** Matthes Ch.1-7 закрыты полностью (93 учебных скрипта). Детальный план со всеми подглавами — в [`COURSE_PLAN.md`](COURSE_PLAN.md).
- **Стек:** Python 3.10, Miniconda, PyCharm, Git, Docker Desktop
- **Следующий шаг:** Matthes 8.1 (Defining a Function)
...
## 📂 Структура проекта
    ...
    ├── tutorials/            # Учебные скрипты по Matthes (93+ файлов)
