...
- **Прогресс:** Matthes Ch.1-11 закрыты полностью (включая Главу 11: Testing Your Code) — 158 учебных скриптов. Активный план с прогрессом — в [`COURSE_PLAN.md`](COURSE_PLAN.md); полная карта курса — в [`COURSE_PLAN_FULL.md`](COURSE_PLAN_FULL.md).
...
├── COURSE_PLAN.md            # Активный план курса (прогресс + детали текущего этапа)
├── COURSE_PLAN_FULL.md       # Полная карта курса (все подсекции, аудит-маркеры)
