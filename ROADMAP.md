...
- [x] Eric Matthes — *Python Crash Course (3rd ed.)* (Ch. 5: 5.1-5.3.6, 5.4.1-5.4.2 ✅; осталось 5.4.3, 5.5)
...
|------|----------|--------------|--------|
| 0 | Фундамент: Python Core + ML-основы + математика | 4-5 недель (интегрированный) | 🔄 В процессе (Matthes Ch.1-4 ✅, Ch.5 🔄 — осталось 2 подпункта) |
